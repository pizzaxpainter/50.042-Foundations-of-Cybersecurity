...
# mapping of letters to the correct cipher sequence
...
# mapping of letters to their frequency
...
def decrypt(inp_text, dict):
    decrypted_message = ""

    for char in inp_text:
        # replace the characters with correct mapping
        if char in dict:
            decrypted_message += dict[char]
        else:
...
print(decrypt(encrypted_message, stored_letters))
