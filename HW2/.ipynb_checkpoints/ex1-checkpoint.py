...
attempt = encrypted_message.replace("U", "E").replace("J", "T").replace("Y", "I").replace("Q", "O").replace("I", "S").replace("T", "D").replace("X", "H").replace("D", "N").replace("M", "W").replace("O", "A").replace("S", "I").replace("N", "T").replace("E", "O").replace("T", "N")
#attempt = encrypted_message
#attempt2 = encrypted_message.replace("E", "I")
#attempt = encrypted_message.replace("X", "H")
#attempt = encrypted_message.replace("H", "R")
#attempt = encrypted_message.replace("B", "D")
#attempt = encrypted_message.replace("T", "L")
#attempt = encrypted_message.replace("W", "C")
#attempt = encrypted_message.replace("C", "U")
#attempt = encrypted_message.replace("S", "M")
#attempt = encrypted_message.replace("O", "W")
#attempt = encrypted_message.replace("K", "F")
#attempt = encrypted_message.replace("M", "G")
#attempt = encrypted_message.replace("V", "Y")
#attempt = encrypted_message.replace("F", "P")
#attempt = encrypted_message.replace("R", "V")
#attempt = encrypted_message.replace("L", "K")
#attempt = encrypted_message.replace("A", "J")
#attempt = encrypted_message.replace("Z", "X")
#attempt = encrypted_message.replace("N", "Q")
#attempt = encrypted_message.replace("P", "Z")
